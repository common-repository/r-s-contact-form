    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="panel_s"> 
                ...
                <div class="panel-body">
                <div class="_buttons">
              <span class="message-heading mright5 test pull-left display-block"><?php esc_html_e( 'Inbox', 'contact' ); ?></span>
              </div>
              </div>
          <div class="panel-body">
                  ...
                  <div class="bulk-body">
                      <div class="_buttons">
                        ...
                        <button id="bulk_spam" type="button" class="bulk-btn move-color pull-left display-block mright5" title="Move to spam" style="display: none"> <i class="fa fa-wrench"></i></button>
                          ...
                          <button id="bulk_trash" type="button" class="bulk-btn move-color pull-left display-block mright5" title="Move to trash" style="display: none"> <i class="fa fa-trash"></i></button>
                    ...
                    <tbody>
                        <?php $i = 0; foreach ( rscf_get_messages('inbox') as $value): $i++;?>
                        <tr class="<?php echo $value->view_status == 'inbox_new' ? 'new_message' : 'old_message'?>" id="<?php echo $value->msg_id; ?>">
                            ...
                            <td class="sender_name"><a class="link_color" href="admin.php?page=rscf-details&id=<?php echo $value->msg_id; ?>"><?php echo esc_html( $value->sender_name, 'contact' ); ?></a> <span class="message_time"><?php echo esc_html(rscf_time_ago($value->msg_date), 'contact'); ?></span></td>
                            ...
                            <td class="option_button">
                                ...
                                <a href="javascript:void(0)" data-id="<?php echo $value->msg_id; ?>" data-nonce="<?php echo wp_create_nonce('trash_contact_nonce') ?>" class="btn btn-danger message_trash btn-icon" title="Move to trash"><i class="fa fa-trash"></i></a>
