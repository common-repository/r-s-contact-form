        ...
        <div class="col-md-10">
            <div class="panel_s">
              <?php include 'compose.php';?>
                <div class="panel-body">
                <div class="_buttons">
              <span class="message-heading mright5 test pull-left display-block"><?php esc_html_e( 'Draft', 'contact' ); ?></span>
              </div>
              </div>
          <div class="panel-body">
            <table id="messageTable" class="table">
                    ...
                    <tbody>
                        <?php $i = 0; foreach ( rscf_get_messages('rscf-draft') as $value): $i++;?>
