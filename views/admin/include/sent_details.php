            <div class="panel_s">
                ...
                <div class="_buttons">
              <span class="message-heading mright5 test pull-left display-block"><?php echo esc_html_e( 'To: '.$messageById['email'], 'contact' ); ?></span>
            ...
            <div class="panel-body">
              ...
              <div class="messagess-details">
                <p><strong><?php echo esc_html( rscf_message_display_name($messageById['auth_id']),'contact' ); ?></strong> < <?php echo esc_html__( rscf_message_smtp_data('smtp_email'),'contact' ); ?> ></p>
                <div class="message_details_popup">
                  <small class="font-medium-xs small_details"><?php esc_html_e( 'to sent', 'contact' ) ?> <i class="fa fa-caret-down" aria-hidden="true"></i></small>
