    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="panel_s">
                ...
                <div class="panel-body">
                <div class="_buttons">
              <span class="message-heading btn-infos mright5 test pull-left display-block"><?php esc_html_e( 'Spam', 'contact' ); ?></span>
              </div>
              </div>
          <div class="panel-body">
            <table id="messageTable" class="table">
                    ...
                    <tbody>
                        <?php $i = 0; foreach ( rscf_get_messages('inbox_spam') as $value): $i++;?>
